...
function fixFlexsliderHeight() {
    ...
    $('.flexslider').each(function(){
		...
		$(this).find('.slides > li >img').each(function(){
			...
			var $heightimg = 300 ;
      $(".top").css("margin-top", "-3%");
      $(".top").css("margin-left", "-9%");
      $(".next").css("margin-top", "-14%");
      if($winwidth < 800)
      {
        $(".top").css("margin-left", "0%");
        $(".next").css("margin-top", "-24%");
        $(".top").css("margin-top", "-6%");
      }
			if($winwidth < 500)
      {
				$heightimg = 200 ;
        $(".top").css("margin-top", "-18%");
        $(".top").css("margin-left", "0%");
        $(".next").css("margin-top", "-23%");
		

      } 
			$(this).css({'height' : $heightimg} );
